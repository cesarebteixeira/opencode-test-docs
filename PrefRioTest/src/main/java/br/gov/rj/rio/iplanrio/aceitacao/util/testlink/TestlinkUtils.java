...
public class TestlinkUtils {
    ...
    public static int reportaResultadoExecucao(String projeto, String planoTeste, String casoTeste, String nota, String bugID) {
        ...
        if (bugID != null) {
            result = testlink.reportTCResult(testcase, 0, plan.getId(), ExecutionStatus.FAILED, null, build.getId(), null, nota, testcase, false, bugID, 0, null, null, false, bugID, bugID);
        } else {
        	// submete os dados sem o bug associado
            result = testlink.reportTCResult(testcase, 0, plan.getId(), ExecutionStatus.PASSED, null, build.getId(), null, nota, testcase, false, null, 0, null, null, false, bugID, bugID);
    ...
    public static void anexaEvidenciaExecucao(Integer execucao, String arquivo, String titulo, String descricao, String nomeArquivo) {
        ...
        testlink.uploadExecutionAttachment(execucao, titulo, descricao, nomeArquivo, "image/png", Utils.decodeImageToContent(arquivo));
    }
